...
<div class="container mx-auto p-6 flex">
    ...
    <aside class="w-1/4 bg-white shadow-md p-4 rounded-lg">
        ...
        <a href="{{ route('folders.create') }}" class="block px-4 py-2 mb-2 text-black bg-blue-600 rounded-lg text-center hover:bg-blue-700">+ New Folder</a>
    ...
    <main class="w-3/4 p-6">
        @if (request()->has('folder'))
            ...
            @if ($currentFolder)
                ...
                <a href="{{ route('folders.notes.create', $currentFolder) }}" class="block px-4 py-2 mb-2 text-black bg-green-600 rounded-lg text-center hover:bg-green-700">+ New Note</a>
